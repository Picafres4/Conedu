...
class GuiaPersonalizada: UIViewController {
    ...
    @IBAction func generarGuia(_ sender: Any) {
        ...
        let alert = UIAlertController(title: "Sugerencias de estudio:", message: count >= 3 ? "¡Felicidades! Has mencionado la letra 'S' más de 3 veces." : "Te sugerimos estudiar más.", preferredStyle: .alert)
